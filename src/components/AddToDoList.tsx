...
function AddToDoList() {
    ...
    <>
        <form onSubmit={handeFormSubmit} className="text-[1.6vmax] flex justify-evenly items-center font-[Merriweather]">
            ...
            <button type="submit" className="bg-orange-100 px-5 py-2 rounded-xl w-1/3 font-semibold text-orange-900 hover:outline hover:outline-orange-900 font-black italic">Add</button>
        </form>   
    </>
  )
}
